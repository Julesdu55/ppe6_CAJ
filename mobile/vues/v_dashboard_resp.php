...
<html>
    ...
    <body>
        ...
        <div id="bandeau">
            ...
            <div id='erreur' title='Erreur'><center><font size=5 color="#6495ed"><i><b>Vous n'avez pas rempli certains champs</b></i></center></font></div>
            <div id='dialog_ok' title='Enregistrement'><center><font size=5 color="#6495ed"><i><b>L'enregistrement a bien été pris en compte</b></i></center></font></div>
            ...
            if(idTech == '' || dateBug == ''){
                ...
                $.ajax({
                    ...
                    success  : function(data) {
                        ...
                        var paramTech = "#tech_" + idTech;
                        $(paramDate).html(dateBug);
                        $(paramTech).html(idTech);
                    }
                })
            }
            })
